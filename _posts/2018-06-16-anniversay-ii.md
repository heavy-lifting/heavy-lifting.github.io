...
got some super cool stuff already lined up for the next year

## japan

i'm involved in an exchange trip with algoravers in japan in sheffield (in september) and tokyo and osaka (in november).  again thanks to [yaxu](http://slab.org/) and [renick](http://www.renickbell.net/doku.php) for co-ordinating everything.
